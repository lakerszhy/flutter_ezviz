...
class EzvizPlayerController {
  ...
  EzvizPlayerController.init(int id) {
    _channel =
        MethodChannel(EzvizPlayerChannelMethods.methodChannelName + "_$id");
    _eventChannel =
        EventChannel(EzvizPlayerChannelEvents.eventChannelName + "_$id");
  }
...
class _EzvizPlayerState extends State<EzvizPlayer> {
  ...
  Future<void> onPlatformViewCreated(id) async {
    if (widget.onCreated != null) {
      widget.onCreated!(EzvizPlayerController.init(id));
    }
  }
}
